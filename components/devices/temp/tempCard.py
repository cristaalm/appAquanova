...
from components.devices.temp.tempConfigModel import TempConfigModel
import os
...
class TempCard(QFrame):
    def __init__(self, notificationes, parent=None):
        ...
        img_path = os.path.join(os.path.dirname(__file__), '../../../resources/media/sensores/sub_temp.jpg')
        ...
        title = QLabel("<b>Sensor de temperatura</b>")
        ...
        self.desc_text.setText(
            "Mide la temperatura del agua. Ideal para acuarios, hidroponía, cultivos en agua, etc.\n\n"
        )
        ...
        self.save_button.clicked.connect(self.save_temp_config)
        ...
        self._config_model = TempConfigModel()
