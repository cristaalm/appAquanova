...
class tempWaterComponent(QWidget):
    def __init__(self, GraphTemp, parent=None):
        ...
        self.current_temp = CurrentTemp(self.value, self.temp_min, self.temp_max, self.rango_max, self.rango_min)
    ...
    def update_ui(self): 
        if self.current_temp:
            self.current_temp.update_value(self.value)
